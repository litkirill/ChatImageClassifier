...
- **Этап 2 - Разработка алгоритма**: Разработка процесса извлечения текста из изображений с использованием Yandex Vision OCR, которая обеспечивает высокую точность распознавания текста на изображениях. После извлечения текста текстовые данные будут использоваться для классификации с помощью YandexGPT Pro, что позволит определить, относится ли изображение к категории скриншотов переписок или к другим типам изображений.
